...
class SpecialSetting extends React.Component{
    ...
    handleSend(){
        this.props.changeRoom({
            isPrivate: true,
            curRoom: this.props.userInfo.get('username')
        });
    ...
    handleShield(){
        ...
        this.props.setShieldUser({
            isAdd: !this.props.shield.includes(username),
            user: username
        });
    ...
    handleSpecial(){
        ...
        this.props.setSpecialUser({
            isAdd: !this.props.special.includes(username),
            user: username
        });
        this.props.storageSetting();
    }
                ...
                <div className = 'info-card-container'>
                    <div  data-flex = 'main:center dir:top'>
                        <dl data-flex = 'main:left cross:center'>
                            ...
                            <dd data-flex-box = '1'>{userInfo.username}</dd>
                        </dl>
                        <dl data-flex = 'main:left cross:center'>
                    ...
                    <div data-flex = 'dir:left main:center cross:center box:mean' className = 'info-card-footer-ul'>
                        ...
                        >
                           <span>
                                ...
                                {
                                    special.includes(userInfo.username)?'取消关注':'特别关注'
                                }
                           </span>
                        </span>
                        <span 
                        ...
                        >
                           <span>
                                <i className = 'info-card-icon'>&#xe686;</i>
                                {
                                    shield.includes(userInfo.username)?'取消屏蔽':'屏蔽TA'
                                }
                            </span>
                        </span>
                    </div>
