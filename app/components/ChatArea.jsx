...
class ChatArea extends React.Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        // 判断收到消息
        if(1 === npm.length - tpm.length && npm[0].timestamp !==  tpm[0].timestamp && npm[npm.length-1].username === user.username){
                        ...
                        >
                            {
                                messages.map((item,index) => {
                                    ...
                                    let dir = user.username === item.username ? 'right' : 'left';
                                    ...
                                    switch (item.type) {
                                        ...
                                        case 'pluginMessage': {
                                            const messageInfo=(function plugin(){
                                                ...
                                                const message={content:item.content,from:{username:item.username},isNew};
